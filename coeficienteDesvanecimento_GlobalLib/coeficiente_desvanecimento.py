...
class Coeficiente_de_Desvanecimento:
    ...
    def hataCost231(self,d):
        ...
        d0 = 10
        d1 = 50
        L = 46.3+ (33.9*(math.log(fc,10))) - (13.82*(math.log(ht,10))) - 0.8 - (((1.11*(math.log(ht,10)))- 0.7 ))*hr + (1.56*(math.log(fc,10)))
    ...
    def walfishIkegami(self,d,LOS):
        ...
        if LOS == True:
            ...
            PL = 55.9 - (38*math.log(d,10))- ((24.5 + ((1.5*fc)/925))*math.log(fc,10))
