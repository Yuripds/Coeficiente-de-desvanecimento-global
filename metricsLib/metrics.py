...
class Metrics:
    ...
    def data_rate_r1(self,w,B,p1,gama1,N0):
        num = p1*gama1
    ...
    def data_rate_r2(self,w,B,p2,gama2,p1,N0):
        num = p2*gama2
    ...
    def data_rate_r3(self,w,B,p3,gama3,p1,p2,N0):
        num = p3*gama3
    ...
    def data_rate_r4(self,w,B,p4,gama4,p1,p2,p3,N0):
        num = p4*gama4
    ...
    def data_rate_r5(self,w,B,p5,gama5,p1,p2,p3,p4,N0):
        num = p5*gama5
    ...
    def data_rate_r6(self,w,B,p6,gama6,p1,p2,p3,p4,p5,N0):  
        num = p6*gama6
